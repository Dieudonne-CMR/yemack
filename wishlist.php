<!DOCTYPE html>
<html lang="zxx">
    <!-- Mirrored from templates.hibootstrap.com/arrola/default/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 17:10:41 GMT -->
    <head>
        <meta charset="UTF-8" />
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="wishlist.html">
                                                        <img src="assets/images/product-img/product-img4.png" alt="Image" />
                                                    </a>
                                                </td>
                                                <td class="product-name">
                                                    <a href="wishlist.html">Water Melon</a>
                                                </td>
                                                ...
                                                <td class="product-subtotal">
                                                    <a href="cart.html" class="default-btn">Add to Car <i class="bx bx-cart-alt"></i></a>
                                                    <a href="wishlist.html" class="remove remove-mt">
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="wishlist.html">
                                                        <img src="assets/images/product-img/product-img5.png" alt="Image" />
                                                    </a>
                                                </td>
                                                <td class="product-name">
                                                    <a href="wishlist.html">Pomegranate</a>
                                                </td>
                                                <td class="product-price">
                                                    <span class="unit-amount">$40.00</span>
                                                </td>
                                                <td class="product-quantity">
                                                    <span class="instock-text">In Stock</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="wishlist.html">
                                                        <img src="assets/images/product-img/product-img6.png" alt="Image" />
                                                    </a>
                                                </td>
                                                <td class="product-name">
                                                    <a href="wishlist.html">Capsicum</a>
                                                </td>
                                                <td class="product-price">
                            ...
                            <div class="footer-widget ps-5">
                                ...
                                <ul class="footer-contact">
                                    ...
                                    <li>
                                        Email:
                                        <span>
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#a7cfc2cbc8e7c6d5d5c8cbc689c4c8ca">
                                                <span class="__cf_email__" data-cfemail="f69e939a9a99b6978484999a97d895999b">[email&#160;protected]</span>
                                            </a>
                                            <br />
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#83eaede5ecc3e2f1f1ecefe2ade0ecee">
                                                <span class="__cf_email__" data-cfemail="f59c9b939ab59487879a9994db969a98">[email&#160;protected]</span>
                                            </a>
                                        </span>
                                    </li>
                                    <li>
